...
namespace INIFile
{
     ...
     */
        ...
        #region 二次封装
        public static bool readKey(string iniFile, string section, string key, ref string value)
        {
            string str = INIGetStringValue(iniFile, section, key, null);
            if (str == null)
            {
                return false;
            }
        ...
        public static bool readKey(string iniFile, string section, string key, ref int value)
        {
        ...
        public static bool readKey(string iniFile, string section, string key, ref double value)
        {
        ...
        public static bool readKey(string iniFile, string section, string key, ref float value)
        {
        ...
        public static bool readKey(string iniFile, string section, string key, ref short value)
        {
        ...
        public static bool readKey(string iniFile, string section, string key, ref bool value)
        {
        ...
        public static bool readKey(string iniFile, string section, string key, ref long value)
        {
        ...
        public static bool writeKey(string iniFile, string section, string key, string value)
        {
            return INIWriteValue(iniFile, section, key, value);
        }

        public static bool writeKey(string iniFile, string section, string key, int value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }

        public static bool writeKey(string iniFile, string section, string key, double value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }

        public static bool writeKey(string iniFile, string section, string key, float value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }

        public static bool writeKey(string iniFile, string section, string key, bool value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }

        public static bool writeKey(string iniFile, string section, string key, long value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }

        public static bool writeKey(string iniFile, string section, string key, short value)
        {
            return INIWriteValue(iniFile, section, key, value.ToString());
        }
        ...
        public static void TestIniINIOperation()
        {
            ...
            string file = "D:\\DATA\\TestIni.ini";
            ...
            writeKey(file, "test", "money", 10000);
            int x = 0;
            readKey(file, "test", "money", ref x);

            writeKey(file, "test", "xmoney", 10000);

            writeKey(file, "test", "mm", "工服");
