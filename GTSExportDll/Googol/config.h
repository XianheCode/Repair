...
GT_API GT_FlashToSdram(long *pRetry=nullptr);
GT_API GT_SdramToFlash(long *pRetry=nullptr);
GT_API GT_SdramToFlash2(long *pRetry=nullptr);
GT_API GT_TestSdram();
...
GT_API GT_GetCaptureCount(short encoder,unsigned long *pCount,short count=1,unsigned long *pClock=nullptr);

GT_API GT_GetEncPosModulo(short encoder,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetEncPosRegist(short encoder,double *pValue,short count=1,unsigned long *pClock=nullptr);
