...
GT_API GT_GetDac(short dac,short *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAdc(short adc,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAdcValue(short adc,short *pValue,short count=1,unsigned long *pClock=nullptr);

GT_API GT_SetEncPos(short encoder,long encPos);
GT_API GT_GetEncPos(short encoder,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetEncPosPre(short encoder,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetEncVel(short encoder,double *pValue,short count=1,unsigned long *pClock=nullptr);

GT_API GT_SetCaptureMode(short encoder,short mode);
GT_API GT_GetCaptureMode(short encoder,short *pMode,short count=1);
GT_API GT_GetCaptureStatus(short encoder,short *pStatus,long *pValue,short count=1,unsigned long *pClock=nullptr);
...
GT_API GT_Reset();
GT_API GT_GetClock(unsigned long *pClock,unsigned long *pLoop=nullptr);
GT_API GT_GetClockHighPrecision(unsigned long *pClock);

GT_API GT_GetSts(short axis,long *pSts,short count=1,unsigned long *pClock=nullptr);
...
GT_API GT_GetPrfPos(short profile,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetPrfVel(short profile,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetPrfAcc(short profile,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetPrfMode(short profile,long *pValue,short count=1,unsigned long *pClock=nullptr);

GT_API GT_GetAxisPrfPos(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisPrfVel(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisPrfAcc(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisEncPos(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisEncVel(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisEncAcc(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
GT_API GT_GetAxisError(short axis,double *pValue,short count=1,unsigned long *pClock=nullptr);
...
GT_API GT_GetGearMaster(short profile,short *pMasterIndex,short *pMasterType=nullptr,short *pMasterItem=nullptr);
GT_API GT_SetGearRatio(short profile,long masterEven,long slaveEven,long masterSlope=0);
GT_API GT_GetGearRatio(short profile,long *pMasterEven,long *pSlaveEven,long *pMasterSlope=nullptr);
...
GT_API GT_GetFollowMaster(short profile,short *pMasterIndex,short *pMasterType=nullptr,short *pMasterItem=nullptr);
...
GT_API GT_GetFollowEvent(short profile,short *pEvent,short *pMasterDir,long *pPos=nullptr);
...
GT_API GT_2DCompareStatus(short chn,short *pStatus,long *pCount,short *pFifo,short *pFifoCount,short *pBufCount =nullptr);
